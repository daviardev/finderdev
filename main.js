...
const showUserData = data => {
  const { name, login, created_at: joined, avatar_url: avatar, bio, public_repos: publicRepos, followers, following, location, blog, twitter_username: userTwitter, company } = data
  const userData = `
  <article class='grid-areas card-info'>
    ...
    <div class='section-social social'>
      ...
      <article class='position-elements'>
        ...
        <a class='position' href='${blog}'>${blog}/</a>
      </article>
      ...
      <article class='position-elements'>
        ...
        <a class='position' href='https://www.twitter.com/${userTwitter}'>${userTwitter}</a>
      </article>
